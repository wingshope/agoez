...
clear
echo -e "${PURPLE}┌─────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│                    VMESS MENU                   │$NC"
echo -e "${PURPLE}└─────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌─────────────────────────────────────────────────┐${NC}"
echo -e "     ${PURPLE}[${COLOR1}1${PURPLE}] Create Vmess Account     "
echo -e "     ${PURPLE}[${COLOR1}2${PURPLE}] Trial Vmess Account     "
echo -e "     ${PURPLE}[${COLOR1}3${PURPLE}] Delete Account Vmess     "
echo -e "     ${PURPLE}[${COLOR1}4${PURPLE}] Renew Account Vmess     "
echo -e "     ${PURPLE}[${COLOR1}5${PURPLE}] Cek User XRAY     "
echo -e "     ${PURPLE}[${COLOR1}6${PURPLE}] Detail Vmess Account     "
echo -e ""
echo -e "     ${PURPLE}[${COLOR1}0${PURPLE}] Back To Menu     "
echo -e "${PURPLE}└──────────────────────────────────────────────────┘${NC}"
echo ""
